...
#send_mail('Hello', 'very imp msg....','saikumaradulapuram@gmail.com',['aksharasri619@gmail.com','saik72918@gmail.com'])
...
def mail_send_view(request,id):
    ...
    if request.method=='POST':
        ...
        send_mail(subject,message,'saikumaradulapuram@gmail.com',[cd['to']])
        sent=True;
    else:
        form=EmailSendForm()
